...
C=[
{"id":"P2-2","ep":"/chat","m":"Search my memory for move-in day","to":120,"need_tool":"memory_recall","brain":"qwen2.5:72b"},
...
{"id":"R-4","ep":"/chat","m":"hey babe how was your day","to":90,"brain":"qwen2.5:72b"},
]
def dbq(sql,params=()):
